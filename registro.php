                ...
                <div class="col col-md-10 col-lg-8 col-xl-7">
                    <form action="registroSQL.php" method="POST" class="row caja text-center">
                        ...
                        <div class="col-12 col-md-6 input-group mb-3">
                            ...
                            <span class="input-group-text bi bi-lock-fill ms-3"></span>
                        ...
                        <div class="col-12 input-group mb-3">
                            ...
                            <span class="input-group-text bi bi-phone-fill ms-3"></span>
                            <input class="form-control" type="text" name="tlf" id="tlf" placeholder="Teléfono" required>
                        </div>
                        <div class="col-12 input-group mb-3">
