            ...
            <div class="row justify-content-center">
                <div class="col col-md-10 col-lg-8 col-xl-7">
                    <div class="row caja text-center p-3 justify-content-center justify-content-md-around">
                        ...
                        <div class='col-12 mt-2 mb-4'><a class='btn btn-secondary' href='anadirCategoria.php' role='button'>Añadir categoría</a></div>
                        <?php
                        ...
                        while ($row=mysqli_fetch_assoc($result)) {
                            ...
                            $nombre = $row['nombre'];
                            echo ("
                            <div class='col-6 col-md-4 col-lg-3 h2'>
                            <form method='POST' action='modificarCategoria.php'>
                            <div class='row'>
                            <div class='col-12'>$nombre</div>
                            <div class='col-12'><input type='text' class='form-control' placeholder='Nombre' name='nombre'></div>
                            <input type='hidden' value='$id' name='id'>
                            <div class='col mt-1'><button class='btn btn-secondary w-100' type='submit'>Modificar</button></div>
                            <div class='col mt-1'><a class='btn btn-secondary w-100' href='eliminarCategoria.php?id=$id' role='button'>Eliminar</a></div>                          
                            </div>
                            </form>
                            </div>                            
                            ");
