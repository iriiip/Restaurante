    ...
    <section>
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-12">
                    <form action="anadirProducto.php" enctype="multipart/form-data" method="POST" class="row caja text-center p-3 justify-content-center justify-content-md-around">
